    ...
    initialize_more() {
        ...
        this.verify = () => {
            if (this.buts.every(x => String(x.tag) == String(x.origTag))) {
                ...
                this.animator.add_anim(this.guidetxt, 500, "stepMany",
                    {
                        varNames: ["fontsize"], startVals: [20], endVals: [36],
                        chain:
                            new Anim(this.guidetxt, 500, "step",
                                { varName: "fontsize", startVal: 36, endVal: 28 }),
                        repeat: 6
                    })
            }
        }
