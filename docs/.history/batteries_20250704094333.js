...
`
        ...
        this.tablebg = this.grid[2].splitCol(1, 2)[0]
        this.tablebg.leftat(this.batteries[0].left)

        this.table = this.tablebg.splitRow(...Array(10).fill(1)).map(Button.fromRect)
        ...
        this.makeattempt = (i) => {
            if (this.attempts.first !== i) {
                if (!this.attempts.first) {
                    ...
                    this.batteries[i - 1].color = "red"
                    this.batteries[this.attempts.first - 1].color = "red"
                    this.animator.add_anim(this.batteries[i - 1], 50, "wiggle", { dx: 5, dy: 5 })
                    this.animator.add_anim(this.batteries[this.attempts.first - 1], 50, "wiggle", {
                        dx: 5, dy: 5,
                        on_end: () => {
                    ...
                    this.table[this.attempts.count].txt = `${u}, ${w}`
