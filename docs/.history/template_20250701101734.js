...
class Game {
    ...
    initialize_more() {
        ...
        this.empty = [0, 3]
        //this.logicGrid = MM.mapNested(this.butGrid, x => x.tag)
        this.verify = () => {

        }
        this.swap = (u, w) => {
            if (String(u) == String(w)) {
                return
            }
            const bu = this.butGrid[u[0]][u[1]]
            const bw = this.butGrid[w[0]][w[1]]
            this.butGrid[u[0]][u[1]] = bw
            this.butGrid[w[0]][w[1]] = bu
            console.log(bu.tag, bw.tag)

        }

        this.buts.forEach(b => {
            b.on_click = () => {
                this.swap(b.tag, game.empty)
                game.empty = b.tag
            }
        })
        ...
        this.butGrid[this.empty[0]][this.empty[1]].img = null
