...
class Game {
    ...
    initialize_more() {
        ...
        this.inds = this.rect.splitGrid(5, 5).flat().map(Button.fromRect)
        this.mr = new Button({ x: 10, y: 10, width: 50, height: 50, color: "pink" })
        this.mouser.x = 10
        this.mouser.y = 20
    ...
    /// start update_more:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    update_more(dt) {
        if (this.rect.deflate(60, 60).collidepoint(this.mouser.x, this.mouser.y)) { this.mr.centerat(this.mouser.x, this.mouser.y) }
        //for (member of this.shm.findNear(this.mr)) {
